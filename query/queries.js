...
db.restaurants.find({"grades.score" : {"$gt" : 90}}, {"_id":0, "restaurant_id":1, "name":1, "grades.score": 1});
...
db.restaurants.find({ $or : [{"name" : /^Wil/}, {$and : [{"cuisine" : "Fish"}, {"cuisine" : {$nin : ["American", "Chinese"]}}]}]}, {"_id": 0});
...
db.restaurants.find({"grades.1.grade" : "A", "grades.1.score" : 11, "grades.1.date" : ISODate("2014-08-11T00:00:00Z")},{"_id": 0, "restaurant_id" : 1, "name" : 1, "grades" : 1});
...
db.restaurants.find({$or : [{"address.street" : null}, {"address.street" : ""}, {"address.street" : {$exists : false}}]}, {"_id": 0, "address" : 1});
...
db.restaurants.find({"name" : /mon/}, {"_id": 0, "name" : 1, "borough" : 1, "location.coordinates" : 1, "cuisine" : 1});
