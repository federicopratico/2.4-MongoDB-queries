...
### ⚠️ High Priority Issues
- ⚠️ Examined 156 docs to return 5 (ratio 31.2:1)
...
- 🧪 **Query**: `db.restaurants.find({"grades.score" : {"$gt" : 90}}, {"_id":0, "restaurant_id":1, "name":1, "grades.score": 1})`
- ⏱️ **Execution time**: 1 ms
...
- 🧪 **Query**: `db.restaurants.find({"name" : /Reg/i }, {"_id": 0, "restaurant_id" : 1, "name" : 1, "borough" : 1, "cuisine" : 1})`
- ⏱️ **Execution time**: 1 ms
...
- 🧪 **Query**: `db.restaurants.find({ $or : [{"name" : /^Wil/}, {$and : [{"cuisine" : "Fish"}, {"cuisine" : {$nin : ["American", "Chinese"]}}]}]}, {"_id": 0})`
- ⏱️ **Execution time**: 1 ms
- 📚 **Documents returned**: 2
- 🔍 **Documents examined**: 664
...
- 🧪 **Query**: `db.restaurants.find({"grades.1.grade" : "A", "grades.1.score" : 11, "grades.1.date" : ISODate("2014-08-11T00:00:00Z")},{"_id": 0, "restaurant_id" : 1, "name" : 1, "grades" : 1})`
- ⏱️ **Execution time**: 1 ms
- 📚 **Documents returned**: 0
- 🔍 **Documents examined**: 664
- 🛠️ **Execution stage**: PROJECTION_SIMPLE
...
- 🧪 **Query**: `db.restaurants.find({$or : [{"address.street" : null}, {"address.street" : ""}, {"address.street" : {$exists : false}}]}, {"_id": 0, "address" : 1})`
- ⏱️ **Execution time**: 1 ms
...
- 🧪 **Query**: `db.restaurants.find({"grades" : {$elemMatch : {"score" : {$mod : [7,0]}}}}, {"_id": 0, "restaurant_id" : 1, "name" : 1, "grades" : 1})`
- ⏱️ **Execution time**: 1 ms
...
- 🧪 **Query**: `db.restaurants.find({"grades" : {$elemMatch : {"score" : {$gt : 80, $lt : 100}}}}, {"_id": 0, "restaurant_id" : 1, "name" : 1, "grades" : 1})`
- ⏱️ **Execution time**: 1 ms
- 📚 **Documents returned**: 1
- 🔍 **Documents examined**: 664
- 🛠️ **Execution stage**: PROJECTION_SIMPLE
